...
const Other = ({
  ...
  return (
    <WrapperScale>
      ...
      <div className="list2">
        <div className="in">
          <p>Соответствие работы тематике конкурса</p>
        </div>
        <div className="in">
          <CheckboxAmount
        ...
        <div className="in">
          <p>Качество выполнения работы</p>
        </div>
        <div className="in">
          <CheckboxAmount
        ...
        <div className="in">
          <p>Чистота техники выполнения</p>
        </div>
        <div className="in">
          <CheckboxAmount
        ...
        <div className="in">
          <p>Выражение личного отношения к идее работы</p>
        </div>
        <div className="in">
          <CheckboxAmount
        ...
        <div className="in">
          <p>Безошибочное выполнение работы</p>
        </div>
        <div className="in">
          <CheckboxAmount
