...
const ANay = ({ nomPul, type, link, file, id, passState, passStateAmount }) => {
  ...
  return (
    <WrapperScale>
      ...
      <div className="list2">
        <div className="in">
          <p>
            Степень соответствия содержания методической работы требованиям ФГОС
          </p>
        </div>
        <div className="in">
          <CheckboxAmount
        ...
        <div className="in">
          <p>Методическая ценность работы, новизна материала </p>
        </div>
        <div className="in">
          <CheckboxAmount
        ...
        <div className="in">
          <p>
            Практичность внедрения материалов в изучение и сохранение родного
            языка
          </p>
        </div>
        <div className="in">
        ...
        <div className="in">
          <p>Стиль изложения: доступность, наглядность, логичность </p>
        </div>
        <div className="in">
          <CheckboxAmount
        ...
        <div className="in">
          <p>
            Творческий характер работы, нестандартность решения педагогической
            проблемы
          </p>
        </div>
        <div className="in">
        ...
        <div className="in">
          <p>Культура оформления материалов </p>
        </div>
        <div className="in">
          <CheckboxAmount
