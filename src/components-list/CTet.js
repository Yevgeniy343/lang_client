  ...
  return (
    <WrapperScale>
      ...
      <div className="list2">
        <div className="in">
          <p>
            Художественная значимость литературного материала (знание текста
            наизусть, исполнение материала на родном языке)
          </p>
        </div>
        <div className="in">
          <CheckboxAmount
        ...
        <div className="in">
          <p>
            Качество исполнения на родном языке (техника речи, дикционная
            культура, владение родным языком, его орфоэпическими нормами)   
          </p>
        </div>
        <div className="in">
          <CheckboxAmount
        ...
        <div className="in">
          <p>Артистизм и эмоциональность</p>
        </div>
        <div className="in">
          <CheckboxAmount
        ...
        <div className="in">
          <p>Донесение смыслового содержания исполняемого произведения </p>
        </div>
        <div className="in">
          <CheckboxAmount
