  ...
  return (
    <WrapperScale>
      ...
      <div className="list2">
        ...
        <div className="in">
          <p>
            Выражение личного отношения, артистизм, применение выразительных
            средств (мимики, жестов, движений)
          </p>
        </div>
        <div className="in">
          <CheckboxAmount
        ...
        <div className="in">
          <p>
            Качество записи: звук четкий, без лишних шумов, запись со штатива +
            5 баллов, за каждое нарушение – 1 балл
          </p>
        </div>
        <div className="in">
          <CheckboxAmount
