...
const AFra = ({ nomPul, type, link, file, id, passState, passStateAmount }) => {
  ...
  return (
    <WrapperScale>
      ...
      <div className="list2">
        <div className="in">
          <p>
            Соответствие цели внеурочного мероприятия теме сохранения, изучения
            родного языка
          </p>
        </div>
        <div className="in">
        ...
        <div className="in">
          <p>
            Отражение деятельности педагога: насколько методы и форма
            мероприятия соответствуют поставленной цели{" "}
          </p>
        </div>
        <div className="in">
          <CheckboxAmount
        ...
        <div className="in">
          <p>
            Продуктивность (совместная работа учитель / ученик), вовлечение
            учащихся
          </p>
        </div>
        <div className="in">
        ...
        <div className="in">
          <p>Комфортная эмоциональная обстановка внеурочного мероприятия</p>
        </div>
        <div className="in">
          <CheckboxAmount
        ...
        <div className="in">
          <p>
            Результативность мероприятия, его познавательная, нравственная
            ценность
          </p>
        </div>
        <div className="in">
        ...
        <div className="in">
          <p>Языковая грамотность педагога, чистота языка </p>
        </div>
        <div className="in">
          <CheckboxAmount
