...
const AVok = ({ nomPul, type, link, file, id, passState, passStateAmount }) => {
  ...
  return (
    <WrapperScale>
      ...
      <div className="list2">
        <div className="in">
          <p>
            Актуальность: степень новизны, социальная и практическая значимость
            материалов
          </p>
        </div>
        <div className="in">
        ...
        <div className="in">
          <p>
            Технологичность: применение навыков ИКТ и их взаимодействие с
        ...
        <div className="in">
          <p>
            Вовлечение учащихся в деятельность по изучению родного языка через
            представленную технологию
          </p>
        </div>
        <div className="in">
          <CheckboxAmount
        ...
        <div className="in">
          <p>Уникальность материала, авторство </p>
        </div>
        <div className="in">
          <CheckboxAmount
        ...
        <div className="in">
          <p>
            Оригинальность представленного опыта: нестандартность решения пед.
            проблемы через инновационные методы обучения
          </p>
        </div>
        <div className="in">
          <CheckboxAmount
        ...
        <div className="in">
          <p>Культура оформления материала</p>
        </div>
        <div className="in">
          <CheckboxAmount
