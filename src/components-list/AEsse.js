...
const AHud = ({ nomPul, type, link, file, id, passState, passStateAmount }) => {
  ...
  return (
    <WrapperScale>
      ...
      <div className="list2">
        <div className="in">
          <p>
            Соответствие работы общей теме конкурса (Родина, родной язык,
            культура)
          </p>
        </div>
        <div className="in">
        ...
        <div className="in">
          <p>Степень владения литературным письменным языком</p>
        </div>
        <div className="in">
          <CheckboxAmount
        ...
        <div className="in">
          <p>Стилистическая, пунктуационная и грамматическая грамотность</p>
        </div>
        <div className="in">
          <CheckboxAmount
        ...
        <div className="in">
          <p>Отражение взглядов автора, самостоятельность оценки и суждения</p>
        </div>
        <div className="in">
          <CheckboxAmount
        ...
        <div className="in">
          <p>Объем, соответствующий возрасту</p>
        </div>
        <div className="in">
          <CheckboxAmount
