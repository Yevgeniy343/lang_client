...
const AVok = ({ nomPul, type, link, file, id, passState, passStateAmount }) => {
  ...
  return (
    <WrapperScale>
      ...
      <div className="list2">
        <div className="in">
          <p>Соответствие репертуара тематике конкурса</p>
        </div>
        <div className="in">
          <CheckboxAmount
        ...
        <div className="in">
          <p>Вокальные данные, исполнительское мастерство</p>
        </div>
        <div className="in">
          <CheckboxAmount
        ...
        <div className="in">
          <p>Харизма, самобытность и оригинальность подачи материала</p>
        </div>
        <div className="in">
          <CheckboxAmount
        ...
        <div className="in">
          <p>Соответствие стиля и манеры исполнения народным традициям</p>
        </div>
        <div className="in">
          <CheckboxAmount
